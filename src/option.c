...
struct vimoption
{
    ...
    linenr_T	scriptLinenr;	/* line number in which the option was last set */
# define SCRIPTID_INIT , 0
# define SCRIPTLINENR_INIT , 0
#else
# define SCRIPTID_INIT
# define SCRIPTLINENR_INIT
#endif
};
...
static struct vimoption options[] =
{
    {"aleph",	    "al",   P_NUM|P_VI_DEF|P_CURSWANT,
			    ...
			    (char_u *)224L,
#endif
					    (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    {"antialias",   "anti", P_BOOL|P_VI_DEF|P_VIM|P_RCLR,
			    ...
			    {(char_u *)FALSE, (char_u *)FALSE}
#endif
			    SCRIPTID_INIT SCRIPTLINENR_INIT},
    {"arabic",	    "arab", P_BOOL|P_VI_DEF|P_VIM|P_CURSWANT,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)FALSE, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    {"arabicshape", "arshape", P_BOOL|P_VI_DEF|P_VIM|P_RCLR,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)TRUE, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"backspace",   "bs",   P_STRING|P_VI_DEF|P_VIM|P_ONECOMMA|P_NODUP,
			    (char_u *)&p_bs, PV_NONE,
			    {(char_u *)"", (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"backupdir",   "bdir", P_STRING|P_EXPAND|P_VI_DEF|P_ONECOMMA
			    ...
			    {(char_u *)DFLT_BDIR, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
...
# endif
    ...
    {"cmdheight",   "ch",   P_NUM|P_VI_DEF|P_RALL,
			    (char_u *)&p_ch, PV_NONE,
			    {(char_u *)1L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    {"cmdwinheight", "cwh", P_NUM|P_VI_DEF,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)7L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"columns",	    "co",   P_NUM|P_NODEFAULT|P_NO_MKRC|P_VI_DEF|P_RCLR,
			    ...
			    {(char_u *)80L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"compatible",  "cp",   P_BOOL|P_RALL,
			    (char_u *)&p_cp, PV_NONE,
			    {(char_u *)TRUE, (char_u *)FALSE} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"cscopepathcomp", "cspc", P_NUM|P_VI_DEF|P_VIM,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)0L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"directory",   "dir",  P_STRING|P_EXPAND|P_VI_DEF|P_ONECOMMA
			    ...
			    {(char_u *)DFLT_DIR, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"esckeys",	    "ek",   P_BOOL|P_VIM,
			    (char_u *)&p_ek, PV_NONE,
			    {(char_u *)FALSE, (char_u *)TRUE} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"fileformat",  "ff",   P_STRING|P_ALLOCED|P_VI_DEF|P_RSTAT|P_NO_MKRC
								  |P_CURSWANT,
			    (char_u *)&p_ff, PV_FF,
			    {(char_u *)DFLT_FF, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
...
# endif
    ...
    {"guiheadroom", "ghr",  P_NUM|P_VI_DEF,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)50L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
...
# endif
    ...
    {"helpheight",  "hh",   P_NUM|P_VI_DEF,
			    (char_u *)&p_hh, PV_NONE,
			    {(char_u *)20L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"history",	    "hi",   P_NUM|P_VIM,
			    (char_u *)&p_hi, PV_NONE,
			    {(char_u *)0L, (char_u *)50L} SCRIPTID_INIT SCRIPTLINENR_INIT},
...
# endif
    ...
    {"listchars",   "lcs",  P_STRING|P_VI_DEF|P_RALL|P_ONECOMMA|P_NODUP,
			    ...
			    {(char_u *)"eol:$", (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
...
# endif
    ...
    {"matchtime",   "mat",  P_NUM|P_VI_DEF,
			    ...
			    {(char_u *)5L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    {"maxcombine",  "mco",  P_NUM|P_VI_DEF|P_CURSWANT,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)2, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    {"maxfuncdepth", "mfd", P_NUM|P_VI_DEF,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)100L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    {"maxmapdepth", "mmd",  P_NUM|P_VI_DEF,
			    (char_u *)&p_mmd, PV_NONE,
			    {(char_u *)1000L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"menuitems",   "mis",  P_NUM|P_VI_DEF,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)25L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
...
# endif
    ...
    {"mousetime",   "mouset",	P_NUM|P_VI_DEF,
			    ...
			    {(char_u *)500L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"mzquantum",  "mzq",   P_NUM,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)100L, (char_u *)100L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"numberwidth", "nuw",  P_NUM|P_RWIN|P_VIM,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)8L, (char_u *)4L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"previewheight", "pvh", P_NUM|P_VI_DEF,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)12L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
...
# endif
   ...
   {"printmbcharset", "pmbcs",  P_STRING|P_VI_DEF,
    ...
    {"pumwidth",    "pw",   P_NUM|P_VI_DEF,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)15L, (char_u *)15L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"redrawtime",  "rdt",  P_NUM|P_VI_DEF,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)2000L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"report",	    NULL,   P_NUM|P_VI_DEF,
			    ...
			    {(char_u *)2L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
...
# endif
    ...
    {"shiftwidth",  "sw",   P_NUM|P_VI_DEF,
			    (char_u *)&p_sw, PV_SW,
			    {(char_u *)8L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"swapsync",    "sws",  P_STRING|P_VI_DEF,
			    ...
			    {(char_u *)"fsync", (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"tabpagemax",  "tpm",  P_NUM|P_VI_DEF,
			    ...
			    {(char_u *)10L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"tagcase",	    "tc",   P_STRING|P_VIM,
			    (char_u *)&p_tc, PV_TC,
			    {(char_u *)"followic", (char_u *)"followic"} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"titlelen",    NULL,   P_NUM|P_VI_DEF,
			    ...
			    (char_u *)NULL, PV_NONE,
#endif
			    {(char_u *)85L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"ttyscroll",   "tsl",  P_NUM|P_VI_DEF,
			    ...
			    {(char_u *)999L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"undoreload",  "ur",   P_NUM|P_VI_DEF,
			    (char_u *)&p_ur, PV_NONE,
			    { (char_u *)10000L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    {"updatecount", "uc",   P_NUM|P_VI_DEF,
			    (char_u *)&p_uc, PV_NONE,
			    {(char_u *)200L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
    {"updatetime",  "ut",   P_NUM|P_VI_DEF,
			    (char_u *)&p_ut, PV_NONE,
			    {(char_u *)4000L, (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
...
# endif
    ...
    {"whichwrap",   "ww",   P_STRING|P_VIM|P_ONECOMMA|P_FLAGLIST,
			    (char_u *)&p_ww, PV_NONE,
			    {(char_u *)"", (char_u *)"b,s"} SCRIPTID_INIT SCRIPTLINENR_INIT},
    ...
    {"wildmode",    "wim",  P_STRING|P_VI_DEF|P_ONECOMMA|P_NODUP,
			    ...
			    {(char_u *)"full", (char_u *)0L} SCRIPTID_INIT SCRIPTLINENR_INIT},
...
/* terminal key codes are not in here */
    ...
    /* end marker */
    {NULL, NULL, 0, NULL, PV_NONE, {NULL, NULL} SCRIPTID_INIT SCRIPTLINENR_INIT}
};
	...
	else
	{
		...
		if (opt_idx >= 0)
		{
			...
			if (varp == options[opt_idx].var)
			    last_set_msg(options[opt_idx].scriptID, options[opt_idx].scriptLinenr);
			else if ((int)options[opt_idx].indir & PV_WIN)
			    last_set_msg(curwin->w_p_scriptID[
				      (int)options[opt_idx].indir & PV_MASK], options[opt_idx].scriptLinenr);
...
set_option_scriptID_idx(int opt_idx, int opt_flags, int id)
{
	...
	options[opt_idx].scriptLinenr = sourcing_lnum;
    }
